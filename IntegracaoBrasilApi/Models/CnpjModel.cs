...
namespace IntegracaoBrasilApi.Models
{
    ...
    public class SocioAdministradorModel
    {
    ...
    public class CnpjModel
    {
        ...
        public List<SocioAdministradorModel>? Qsa { get; set; }
        ...
        public List<CnaesModel>? CnaesSecundarios { get; set; }

        [JsonPropertyName("natureza_juridica")]
        public string? NaturezaJuridica { get; set; }

        [JsonPropertyName("regime_tributario")]
        public List<RegimeTributarioModel>? RegimeTributario { get; set; }
